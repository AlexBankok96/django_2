    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_send_at', models.DateTimeField(default=datetime.datetime(2024, 11, 28, 17, 51, 14, 76630), verbose_name='Дата и время первой отправки')),
                ('finish_send_at', models.DateTimeField(default=datetime.datetime(2024, 11, 28, 17, 51, 14, 76630), verbose_name='Дата и время окончания отправки')),
                ('status', models.CharField(choices=[('completed', 'Завершена'), ('created', 'Создана'), ('running', 'Запущена')], default='created', max_length=9, verbose_name='Статус')),
            ],
            options={
